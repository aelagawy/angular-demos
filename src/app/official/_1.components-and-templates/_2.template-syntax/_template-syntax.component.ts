 ...
 */
@Component({
  templateUrl: './_template-syntax.component.html',
  styleUrls: [ './_template-syntax.component.css' ]
})
export class TemplateSyntaxComponent implements AfterViewInit, OnInit {
